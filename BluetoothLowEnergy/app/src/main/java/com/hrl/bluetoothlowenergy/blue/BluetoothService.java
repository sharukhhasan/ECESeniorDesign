...
public class BluetoothService {
    ...
    // Application specific UUID's
    private static final UUID UUID_ANDROID_DEVICE = UUID.fromString("c556197a-235c-429d-b180-7e3069f64b4e");
    ...
    // Write to the ConnectedThread non-sync
    ...
    // Thread to listen for incoming connections. Runs until a connection is accepted
