...
public class SmoothBluetooth {
    ...
    private com.hrl.bluetoothlowenergy.blue.BluetoothService mBluetoothService;
    ...
    private void setupService() {
        mBluetoothService = new com.hrl.bluetoothlowenergy.blue.BluetoothService(mHandler);
    }

    private void startService(boolean isAndroid, boolean secure) {
        if (isServiceAvailable()) {
            if (mBluetoothService.getState() == com.hrl.bluetoothlowenergy.blue.BluetoothService.STATE_NONE) {
    ...
    public void send(byte[] data, boolean CRLF) {
        if(isServiceAvailable() && mBluetoothService.getState() == com.hrl.bluetoothlowenergy.blue.BluetoothService.STATE_CONNECTED) {
            if(CRLF) {
    ...
    private final Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case com.hrl.bluetoothlowenergy.blue.BluetoothService.MESSAGE_WRITE:
                    break;
                case com.hrl.bluetoothlowenergy.blue.BluetoothService.MESSAGE_READ:
                    ...
                    // }
                    break;
                case com.hrl.bluetoothlowenergy.blue.BluetoothService.MESSAGE_DEVICE_NAME:
                    if(mListener != null) {
                        mListener.onConnected(mCurrentDevice);
                    }
                    isConnected = true;
                    break;
                case com.hrl.bluetoothlowenergy.blue.BluetoothService.MESSAGE_STATE_CHANGE:
                    /*if(mBluetoothStateListener != null)
                        mBluetoothStateListener.onServiceStateChanged(msg.arg1);*/
                    if(isConnected && msg.arg1 != com.hrl.bluetoothlowenergy.blue.BluetoothService.STATE_CONNECTED) {
                        isConnected = false;
                        if (mListener != null) {
                    ...
                    if(!isConnecting && msg.arg1 == com.hrl.bluetoothlowenergy.blue.BluetoothService.STATE_CONNECTING) {
                        isConnecting = true;
                    } else if(isConnecting) {
                        isConnecting = false;
                        if(msg.arg1 != com.hrl.bluetoothlowenergy.blue.BluetoothService.STATE_CONNECTED) {
                            if (mListener != null) {
