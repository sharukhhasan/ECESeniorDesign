...
public class RecyclerViewBinderCore {
    ...
    public <T extends RecyclerViewItem> void add(final BaseViewBinder<T> binder, final Class<? extends BaseViewHolder<T>> viewHolder, final int layoutId) {
    ...
    private static Object instantiate(final Class<?> clazz, View parentView) {
        try {
