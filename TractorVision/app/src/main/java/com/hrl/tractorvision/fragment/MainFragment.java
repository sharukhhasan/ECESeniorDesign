package com.hrl.tractorvision.fragment;
...
import com.hrl.tractorvision.activity.HomeActivity;
import com.hrl.tractorvision.service.BluetoothConnectionService;
import com.hrl.tractorvision.util.Constants;

import static com.hrl.tractorvision.util.Constants.ST_NONE;
import static com.hrl.tractorvision.util.Constants.ST_CONNECTED;
import static com.hrl.tractorvision.util.Constants.ST_CONNECTING;
import static com.hrl.tractorvision.util.Constants.ST_DISCONNECTED;
import static com.hrl.tractorvision.util.Constants.ST_DISCONNECTED_BY_USR;
import static com.hrl.tractorvision.util.Constants.ST_ERROR;
import static com.hrl.tractorvision.util.Constants.DEV_INFO_STR;
import static com.hrl.tractorvision.util.Constants.STR_ERROR;
import static com.hrl.tractorvision.util.Constants.STR_NONE;
import static com.hrl.tractorvision.util.Constants.STR_CONNECTED;
import static com.hrl.tractorvision.util.Constants.STR_CONNECTING;
import static com.hrl.tractorvision.util.Constants.STR_DISCONNECTED;
import static com.hrl.tractorvision.util.Constants.STR_DISCONNECTED_BY_USR;
...
public class MainFragment extends Fragment {
    ...
    private BluetoothConnectionService mBtService;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mBluetoothAdapter == null) {
            ...
            Toast.makeText(mainActivity, "Bluetooth not available.", Toast.LENGTH_SHORT).show();
            mainActivity.finish();
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mOn) {
            mButtonBtOn.setText("off");
        } else {
            mButtonBtOn.setText("on");
...
/*
                    ...
                    if (data.hasExtra(BluetoothDevice.EXTRA_DEVICE)) {
                        ...
                        if (mBtService != null) {
                            ...
                            if (mBtService.isConnected()) {
                                ...
                                if (existingDevice != null && mBtService.isConnectedToDevice(deviceMAC)) {
                                    Toast.makeText(getContext(), "Already connected to same device", Toast.LENGTH_SHORT).show();
                            ...
                            mBtService = new BluetoothConnectionService(getContext(), mHandler);
                            mBtService.connect(btDev, true);
                        }

                    }//end of if (data.hasExtra(BluetoothDevice.EXTRA_DEVICE))

                    break;


                }//end of case ACTION_DISCOVERY:
    ...
    private void updateStatusIndicator(int statusCode, @Nullable String devinfo) {
        switch (statusCode) {
            ...
            case ST_NONE:
                mDevInfo = null;
                mConStatus.setText("Not connected");
                break;
            case ST_DISCONNECTED:
                mConStatus.setText(STR_DISCONNECTED);
                mDevInfo = null;
